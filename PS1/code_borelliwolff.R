...
mme_function = function(param) { # Defining the sample moment function.
...
mme_function_loglin = function(param) { # Defining the sample moment function - log-linear case.
  sum((log(data_ps1_q6$Y) - param*log(data_ps1_q6$K) -
         (1-param)*log(data_ps1_q6$L)))/100
}

mme_function_loglin_K = function(param) { # Defining the sample moment function - log-linear "K condition" case.
  sum(data_ps1_q6$K*(log(data_ps1_q6$Y) - param*log(data_ps1_q6$K) -
                       (1-param)*log(data_ps1_q6$L)))/100
}

mme_function_loglin_L = function(param) { # Defining the sample moment function - log-linear "L condition" case.
