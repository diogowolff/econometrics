...
mean((alpha_est_500[,1]-0.8)^2)
mean((alpha_est_500[,2]-0.7)^2)
...
alpha_gmm_minimizer_1000 = function(param, col_index) {
...
var(alpha_est_1000[,2])

mean((alpha_est_1000[,1]-0.8)^2)
mean((alpha_est_1000[,2]-0.7)^2)
...
var(alpha_est_500_s100[,1])
var(alpha_est_500_s100[,2])

mean((alpha_est_500_s100[,1]-0.8)^2)
mean((alpha_est_500_s100[,2]-0.7)^2)





alpha_gmm_minimizer_1000_s100 = function(param, col_index) {
